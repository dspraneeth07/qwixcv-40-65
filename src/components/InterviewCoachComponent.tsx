                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground mb-4">
                            Practice with video recording and get feedback on your body language and presentation
                          </p>
                          <Button>Start Practice</Button>
                        </div>
                      </div>
                    ...
                    <div className="border rounded-lg p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground mb-4">
                            Practice behavioral questions about handling challenges and problem solving
                          </p>
                          <Button>Start Practice</Button>
                        </div>
                      </div>
