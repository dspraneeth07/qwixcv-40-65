        ...
        {isVideoActive && (
          <>
            <video 
              ...
              autoPlay
              muted
              className="w-full h-32 object-cover mb-2 rounded-md hidden"
            />
            ...
            {currentAnalysis && (
              <div className="space-y-3">
                <div>
                  ...
                  <Progress value={calculatePresentationScore(currentAnalysis)} className="h-1.5" />
                </div>
                ...
                {currentAnalysis.suggestions.length > 0 && (
                  <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded-md">
                    <strong>Tip:</strong> {currentAnalysis.suggestions[0]}
                  </div>
                )}
              </div>
            )}
